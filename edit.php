...
<body>
    <div class="container">
        <div class="card text-center">
            ...
            <div class="card-body">
                ...
                ?>
                <form name="myForm" method="POST" onsubmit="return OnSubmitForm()" style="text-align: center;">
                    ...
                    <div class="form-group">
                        ...
                        <!-- Button submit -->
                        <button type="submit" name="submit" onclick="OnSubmitForm()" class="btn btn-sm btn-primary btn-btn-block"> Simpan </button>
                </form>
            </div>
            <?php } ?>
        </div>
    ...
    <script type="text/javascript">
        ...
        var dt = <?php echo json_encode($table, JSON_HEX_TAG); ?>;

        function OnSubmitForm()
        {
            if(dt == 'ams_ix')
            {
                document.myForm.action ="Updates/ams_ix.php";
            } else if(dt == 'paix')
            {
                document.myForm.action ="Updates/paix.php";
            } else if(dt == 'equinix')
            {
                document.myForm.action ="Updates/equinix.php";
            } else 
            {
                document.myForm.action ="Updates/myix.php";
            }
